...
type Account struct {
	...
	CodexTicketWatchdog     *service.OpenAICodexTicketWatchdogStatus `json:"codex_ticket_watchdog,omitempty"`
...
type AdminUsageLog struct {
	UsageLog
	TopicSummary *TopicSummary `json:"topic_summary,omitempty"`
